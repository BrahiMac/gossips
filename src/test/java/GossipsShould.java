...
public class GossipsShould {
	...
	public void bePropagatedByAnyMister() {
		...
		Gossips gossips = new Gossips("Mister White", "Mister Black", "Mister Blue")
	...
	public void beRememberedByDoctors() {
		...
		Gossips gossips = new Gossips("Mister White", "Mister Black", "Dr Brown",
				"Mister Pink").from("White").to("Brown").from("Black").to("Brown")
				.from("Brown").to("Pink");
	...
	public void alwaysBeListenedByAnAgent() {
		...
		Gossips gossips = new Gossips("Mister White", "Mister Grey", "Agent Pink",
				"Mister Blue").from("White").to("Pink").from("Grey").to("Pink")
				.from("Pink").to("Blue");
	...
	public void beStoppedByAnAgent() {
		...
		Gossips gossips = new Gossips("Mister White", "Agent Pink", "Mister Blue")
	...
	public void beDelayedOneTurnByAProfessor() {
		...
		Gossips gossips = new Gossips("Mister White", "Pr Pink", "Mister Blue")
				.from("White").to("Pink").from("Pink").to("Blue");
	...
	public void notBePropagatedByALadyWhenComingAMister() {
		...
		Gossips gossips = new Gossips("Mister White", "Lady Green", "Agent Pink")
	...
	public void beReturnedAndInvertedByGentlemen() {
		...
		Gossips gossips = new Gossips("Mister White", "Sir Rose", "Mister Black")
